    ...
    // typedef tree<int,null_type,less<int>,rb_tree_tag,tree_order_statistics_node_update> pbds;
     ...
     cin>>a>>b;
       for(ll i = 0; i < n; i++){
            if(b[i] == 'c' and a[i]=='a')  q.pb(i);
           else if(b[i] == 'c' and a[i]=='a') q.pb(i);
            else if(b[i] == a[i]){
                if(a[i] != 'b'){
                    // if(!=b)  0 ;
                    ll flag1 = 0;
            ...
            }else if(b[i] == 'a' and a[i]=='c'){
                // cout <<sz(q);
                // cout << q.fr();
                // if(emp == 0 and froin <= curr) = no
                // otherwise yes
                if ((q.em()) or (q.fr() >= curr)){
                  cout << "No" <<nl;
                    flag = 0;
                    break;
                 }else{
        ...
        if(flag && !q.em()) cout << "No" << nl;
        else if(flag) cout << "Yes" <<nl ;
